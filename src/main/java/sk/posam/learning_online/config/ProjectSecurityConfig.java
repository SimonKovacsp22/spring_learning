...
public class ProjectSecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
                ...
                .requestMatchers(antMatcher(HttpMethod.POST,"/courses/publish/**")).hasRole("USER")
                ...
                .requestMatchers(antMatcher(HttpMethod.DELETE,"/courses/delete/curriculum/lectures/**")).hasRole("USER")
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://4.210.33.175","http://localhost:4200"));
